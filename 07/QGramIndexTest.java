...
public class QGramIndexTest {
  ...
  public void checkPrefixEditDistance() {
    ...
    Assert.assertEquals(1, qgi.checkPrefixEditDistance("tübi", "tubi", 1));
    Assert.assertEquals(1, qgi.checkPrefixEditDistance("tübi", "tøbi", 1));
    Assert.assertEquals(0, qgi.checkPrefixEditDistance("tübi", "tübi", 0));
  }
